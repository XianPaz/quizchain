...
export const copy = {
  ...
  game: {
    ...
    waitingStart: "Esperando que el profe arranque el quiz…",
    connectedTo: "Conectado a la sala",
    questionOf: (n, total) => `Pregunta ${n} de ${total}`,
    answerSent: "¡Respuesta enviada!",
    waitingAllAnswers: "Esperando que contesten todos…",
    results: (n) => `RESULTADO DE LA PREGUNTA ${n}`,
    placeToAnswer: (place) => `${place} en acertar`,
    streakBadge: (n) => `🔥 ${n} seguidas`,
    waitingNextQuestion: "Esperando que el profe siga…",
    leaderboard: "TABLA DE POSICIONES",
    you: "vos",
    correctOf: (n, total) => `${n}/${total} correctas`,
    cancelledTitle: "Se cerró la sala",
    cancelledBody: "El profe terminó la sesión sin repartir los premios.",
    yourScore: "TU PUNTAJE",
    backHome: "Volver al inicio",
    finishedTitle: "¡Terminó el quiz!",
    statCorrect: "Correctas",
    statQtkn: "QTKN",
    statRank: "Puesto",
    waitingRewards: "⏳ Esperando que el profe reparta los premios…",
    claimedTitle: "¡Te llegaron los tokens!",
    claimedLabel: "RECIBISTE",
    newBalance: "Tu saldo ahora",
    sentTo: (address) => `Enviado a ${address} en Sepolia`,
  ...
  // Consola del profe.
  host: {
    console: "CONSOLA DEL PROFE",
    room: "Sala",
    joined: (n) => `${n} ${n === 1 ? "alumno" : "alumnos"} en la sala`,
    questionsCount: (n) => `${n} preguntas`,
    shareCode: "COMPARTÍ ESTE CÓDIGO",
    waitingStudents: "Esperando que entren los alumnos…",
    studentsInLobby: "Alumnos en la sala:",
    startDisabled: "Esperando alumnos…",
    start: (n) => `▶ Arrancar el quiz (${n} listos)`,
    questionOf: (n, total) => `Pregunta ${n} de ${total}`,
    answered: "alumnos contestaron",
    showResults: "✓ Se acabó el tiempo — Ver resultados",
    closeNow: "⏭ Cerrar la pregunta ahora",
    results: (n) => `RESULTADO DE LA PREGUNTA ${n}`,
    gotItRight: (n, total) => `${n} de ${total} acertaron`,
    nextQuestion: (n, total) => `Siguiente pregunta (${n}/${total}) →`,
    endQuiz: "🏁 Terminar el quiz y calcular puntajes",
    finalScores: "PUNTAJES FINALES",
    correctOf: (n, total) => `${n}/${total} correctas`,
    distribute: "⬡ Repartir los premios en la cadena",
    distributing: "⏳ Esperando que confirmes en MetaMask…",
    rewardsSent: "¡Premios enviados!",
    rewardsSentBody: "Los tokens se enviaron a todos los alumnos en Sepolia.",
    viewOnEtherscan: "🔗 Ver en Etherscan",
    backToDashboard: "Volver al panel",
    // El servidor rechazó un comando. La consola no puede seguir sola.
    rejected: {
      not_a_host: "Perdiste el control de esta sala. Volvé a entrar.",
      session_gone: "La sala ya no existe.",
      host_moved: "Abriste la sala en otra pestaña. Usá esa, o volvé a entrar acá.",
      invalid_question_index: "Esa pregunta no existe en este quiz.",
      already_scored: "Esa pregunta ya se puntuó. Seguí con la siguiente.",
      question_still_open: "Todavía hay una pregunta abierta. Cerrala antes de seguir.",
      not_the_open_question: "Esa no es la pregunta que está abierta ahora.",
      bad_host_token: "Esta sala ya no reconoce tu sesión de profe. Volvé a crearla.",
      default: "El servidor no aceptó la acción. Probá de nuevo.",
    },
  },
